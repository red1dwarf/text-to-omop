...
CREATE TABLE omop.z_check_voc_1
AS
SELECT
    1 check_id,
    'relationships cycle' AS check_name,
    r.*
FROM omop.concept_relationship r,
    omop.concept_relationship r_int
...
CREATE TABLE omop.z_check_voc_2
AS
SELECT 
    2 check_id,
...
CREATE TABLE omop.z_check_voc_3
AS
SELECT 
    3 check_id,
...
WHERE r.relationship_id = rel.relationship_id
    AND NOT EXISTS (
        SELECT 1
        FROM omop.concept_relationship r_int
...
CREATE TABLE omop.z_check_voc_6
AS
SELECT 
    6 check_id,
...
CREATE TABLE omop.z_check_voc_7
AS
SELECT 
    7 check_id,
...
CREATE TABLE omop.z_check_voc_8
AS
SELECT 
    8 check_id,
...
CREATE TABLE omop.z_check_voc_9
AS
SELECT 
    9 check_id,
...
JOIN omop.concept c2 ON upper(c2.concept_name) = upper(c1.concept_name)
...
CREATE TABLE omop.z_check_voc_10
AS
SELECT 
    10 check_id,
...
CREATE TABLE omop.z_check_voc_11
AS
SELECT 
    11 check_id,
...
CREATE TABLE omop.z_check_voc_12
AS
SELECT 
    12 check_id,
...
CREATE TABLE omop.z_check_voc_13
AS
SELECT 
    13 check_id,
...
CREATE TABLE omop.z_check_voc_14
AS
SELECT 
    14 check_id,
...
FROM
(
    SELECT relationship_id FROM omop.concept_relationship
    EXCEPT DISTINCT
    SELECT relationship_id FROM omop.relationship
);

DROP TABLE IF EXISTS omop.z_check_voc_15;
CREATE TABLE omop.z_check_voc_15
AS
SELECT 
    15 check_id,
...
FROM
(
    SELECT concept_class_id FROM omop.concept
    EXCEPT DISTINCT
    SELECT concept_class_id FROM omop.concept_class
);

DROP TABLE IF EXISTS omop.z_check_voc_16;
CREATE TABLE omop.z_check_voc_16
AS
SELECT 
    16 check_id,
...
FROM
(
    SELECT domain_id FROM omop.concept
    EXCEPT DISTINCT
    SELECT domain_id FROM omop.domain
);

DROP TABLE IF EXISTS omop.z_check_voc_17;
CREATE TABLE omop.z_check_voc_17
AS
SELECT 
    17 check_id,
...
FROM
(
    SELECT vocabulary_id FROM omop.concept
    EXCEPT DISTINCT
    SELECT vocabulary_id FROM omop.vocabulary
);

-- create and show summary

DROP TABLE IF EXISTS omop.z_check_voc_errors_summary;
CREATE TABLE omop.z_check_voc_errors_summary
AS
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_1
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_2
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_3
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_6
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_7
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_8
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_9
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_10
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_11
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_12
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_13
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_14
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_15
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_16
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM omop.z_check_voc_17
    GROUP BY check_id, check_name
;

SELECT * FROM omop.z_check_voc_errors_summary
ORDER BY check_id;
