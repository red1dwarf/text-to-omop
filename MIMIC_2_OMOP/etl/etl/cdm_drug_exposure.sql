...
DROP TABLE IF EXISTS omop.cdm_drug_exposure;
CREATE TABLE omop.cdm_drug_exposure
(
...
INSERT INTO omop.cdm_drug_exposure
SELECT
    ('x' || substr(md5(gen_random_uuid()::text), 1, 16))::bit(64)::bigint AS drug_exposure_id,
    per.person_id AS person_id,
    src.target_concept_id AS drug_concept_id,
    CAST(src.start_datetime AS DATE) AS drug_exposure_start_date,
    src.start_datetime AS drug_exposure_start_datetime,
