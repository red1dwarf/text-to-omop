...
DROP TABLE IF EXISTS omop.cdm_device_exposure;
CREATE TABLE omop.cdm_device_exposure
(
...
INSERT INTO omop.cdm_device_exposure
SELECT
    ('x' || substr(md5(gen_random_uuid()::text), 1, 16))::bit(64)::bigint AS device_exposure_id,
    per.person_id AS person_id,
    src.target_concept_id AS device_concept_id,
    CAST(src.start_datetime AS DATE) AS device_exposure_start_date,
    src.start_datetime AS device_exposure_start_datetime,
