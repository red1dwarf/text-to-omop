...
CREATE TABLE omop.voc_concept AS
SELECT * FROM omop.concept
;

CREATE TABLE omop.voc_concept_relationship AS
SELECT * FROM omop.concept_relationship
;

CREATE TABLE omop.voc_vocabulary AS
SELECT * FROM omop.vocabulary
;

CREATE TABLE omop.voc_domain AS
SELECT * FROM omop.domain
;

CREATE TABLE omop.voc_concept_class AS
SELECT * FROM omop.concept_class
;

CREATE TABLE omop.voc_relationship AS
SELECT * FROM omop.relationship
;

CREATE TABLE omop.voc_concept_synonym AS
SELECT * FROM omop.concept_synonym
;

CREATE TABLE omop.voc_concept_ancestor AS
SELECT * FROM omop.concept_ancestor
;

CREATE TABLE omop.voc_drug_strength AS
SELECT * FROM omop.drug_strength
;
