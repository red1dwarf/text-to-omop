...
CREATE TABLE omop.src_patients AS
SELECT 
    subject_id                          AS subject_id,
    anchor_year                         AS anchor_year,
    anchor_age                          AS anchor_age,
...
FROM
    mimiciv_subset.patients
;


-- admissions

CREATE TABLE omop.src_admissions AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
    admittime                           AS admittime,
...
FROM
	mimiciv_subset.admissions
;


-- transfers

CREATE TABLE omop.src_transfers AS
SELECT
    transfer_id                         AS transfer_id,
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
